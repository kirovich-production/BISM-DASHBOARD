...
export default function DashboardSidebar({ 
  ...
  const generateMenuItems = () => {
    ...
    // Agregar secciones dinámicas (excepto consolidado)
    availableSections
    ...
    if (hasConsolidado) {
      ...
      // Agregar opción de gráficos de consolidado
      items.push({
        id: 'graficos-consolidado',
        label: 'Gráficos de Consolidado',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
