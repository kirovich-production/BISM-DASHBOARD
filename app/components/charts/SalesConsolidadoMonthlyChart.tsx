...
interface SalesConsolidadoMonthlyChartProps {
...
const SalesConsolidadoMonthlyChart = forwardRef<ChartRef, SalesConsolidadoMonthlyChartProps>(
    ...
    useImperativeHandle(ref, () => ({
      exportToPNG: () => {
        if (chartRef.current) {
          ...
          link.download = `ventas-mensuales-consolidado-${new Date().toISOString().split('T')[0]}.png`;
          link.href = url;
          link.click();
        }
      },
      ...
      datasets: [
        {
          ...
          data: displayData.map(d => d.consolidado),
...
SalesConsolidadoMonthlyChart.displayName = 'SalesConsolidadoMonthlyChart';

export default SalesConsolidadoMonthlyChart;
